...
// const drivingPerson =obj.filter(person => person.driving == true && person.age >18);
// console.log(drivingPerson);


// soyadi Aliyev olanlari ve yasi 18 den asagi olanlari  secib bir arrayde geri qaytarin

// const differentPerson = obj.filter(person => person.surname == "Aliyev" && person.age<18);
